...
const NOTIFICATION_TEMPLATES = {
  ...
  WORKFLOW_SELF_HANDLED: { title: 'ศูนย์รับดำเนินการเอง',          message: (n) => `เรื่องร้องเรียน ${n} ถูกรับดำเนินการโดยศูนย์ดำรงธรรมโดยตรง` },
  ...
  ESCALATION_L1:      { title: (days) => `เร่งรัด: ไม่มีการอัปเดต ${days} วัน`, message: (n, days) => `เรื่องร้องเรียน ${n} ไม่มีการอัปเดตความคืบหน้าเกิน ${days} วัน` },
  ESCALATION_L2:      { title: (days) => `เร่งรัด: ไม่มีการอัปเดต ${days} วัน`, message: (n, days) => `เรื่องร้องเรียน ${n} ไม่มีการอัปเดตความคืบหน้าเกิน ${days} วัน` },
  ESCALATION_L3:      { title: (days) => `เร่งรัดสูงสุด: ไม่มีการอัปเดต ${days} วัน`, message: (n, days) => `เรื่องร้องเรียน ${n} ไม่มีการอัปเดตความคืบหน้าเกิน ${days} วัน กรุณาดำเนินการเร่งด่วน` },
...
const ACTION_MAP = {
  ...
  selfHandle: { type: 'WORKFLOW_SELF_HANDLED', target: 'center' },
