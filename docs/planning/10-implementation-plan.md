...
### Acceptance Criteria
- [x] ดูรายการเรื่องร้องเรียน + Filter + Search + Pagination ได้
- [x] สร้างเรื่องใหม่ + ได้เลขที่เรื่อง
- [x] ดูรายละเอียด + Timeline ได้
- [x] แก้ไขเรื่องได้
- [x] ส่งต่อหน่วยงาน → สถานะเปลี่ยน
- [x] หน่วยงานรับเรื่อง / ส่งคืนได้
- [x] อัปเดตความคืบหน้า + แนบไฟล์ได้
- [x] ส่งผลดำเนินการ → ตรวจผล → ปิดเรื่องได้
- [x] Public: ประชาชนยื่นเรื่องได้ (Guest)
- [x] Public: ติดตามสถานะด้วยเลขที่เรื่องได้
- [x] CRUD User, Agency, Master Data ทำงานถูกต้อง
- [x] Confirm Dialog ก่อน Action สำคัญ
- [x] ⭐ สมาชิก: สมัคร/Login/ดูเรื่องของฉัน/ยื่นเรื่อง/แก้ไขโปรไฟล์ ได้
